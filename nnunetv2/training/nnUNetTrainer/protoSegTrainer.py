...
from nnunetv2.training.nnUNetTrainer.models.nets.protosegnet import ProtoSegNet
...
class protoSegTrainer(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        return ProtoSegNet(plans_manager,dataset_json,configuration_manager,num_input_channels,configer=configer,deep_supervision=enable_deep_supervision)
