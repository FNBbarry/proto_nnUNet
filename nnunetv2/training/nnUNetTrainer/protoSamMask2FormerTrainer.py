...
from nnunetv2.training.nnUNetTrainer.models.nets.protosammask2formernet import ProtoSamMask2FormerNet
...
class protoSamMask2FormerTrainer(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        configer = Configer(configs='/root/autodl-tmp/nnUNet/nnunetv2/training/nnUNetTrainer/configs/protoseg.json') 
        return ProtoSamMask2FormerNet(plans_manager,dataset_json,configuration_manager,num_input_channels,configer=configer,deep_supervision=enable_deep_supervision)
    ...
    def _build_loss(self):
        configer = Configer(configs='/root/autodl-tmp/nnUNet/nnunetv2/training/nnUNetTrainer/configs/protoseg.json')
        configer.add(('data','num_classes'),self.label_manager.num_segmentation_heads)
