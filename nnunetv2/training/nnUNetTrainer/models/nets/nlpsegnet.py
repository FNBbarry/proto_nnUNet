...
class NlpSegNet(nn.Module):
    ...
    def __init__(self, plans_manager,
        ...
        #                                requires_grad=True)
        self.nlp = nn.Linear(in_channels,self.num_classes*self.num_prototype)
    ...
    def forward(self, x_, gt_semantic_seg=None, pretrain_prototype=False):
        ...
        masks_tmp = self.nlp(_c)
        masks = torch.reshape(masks_tmp,(_c.shape[0],masks_tmp.shape[1]//self.num_classes,self.num_classes))
