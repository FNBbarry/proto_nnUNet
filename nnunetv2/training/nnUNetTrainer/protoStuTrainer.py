...
from nnunetv2.training.nnUNetTrainer.models.nets.protostunet import ProtoStuNet
...
class protoStuTrainer(nnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        super().__init__(plans, configuration, fold, dataset_json, unpack_dataset, device)
        self.num_epochs = 5
        self.initial_lr = 4*1e-2
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        return ProtoStuNet(plans_manager,dataset_json,configuration_manager,num_input_channels,configer=configer,deep_supervision=enable_deep_supervision)
